...
## Solutions
1. check for compatible terminal using echo $SHELL

2. used cd  to change directory and mkdir to create one.

3. used 'man touch' and 'tldr touch' to lookup touch.

4. touch semester to create a file called semester.

5. wrote the following into the file one line at a time
#!/bin/sh >> used 'quotes' to make it work and 
echo '#!/bin/sh' > semester
echo curl --head --silent https://missing.csail.mit.edu >> semester. >> is to append.

6. used ./ semester and permission was denied and ls -l was used to check permissions.

7.  used sh to execute the sh program and read the contents of the file semester.

8. used man chmod and tldr chmod to look it up

9. chmod a+rx gave acces and i was able to run directly using ./semester

10. used ./semester 'last-modified' | grep (widows version of 'ctrl + f')"last-modified" > last-modified.txt.

11. cd /sys to go to sys and with cat /sys/class/power_supply/BAT1/capacity to see battery power level.