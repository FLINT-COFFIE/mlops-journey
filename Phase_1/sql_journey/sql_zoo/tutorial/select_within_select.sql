...
SELECT name, continent, population FROM world WHERE 25000000 > ALL (SELECT population FROM world)
...
SELECT name, continent FROM world x WHERE 1/3 * x.population > ALL (SELECT population FROM world y WHERE x.continent = y.continent AND y.name  <> x.name AND population > 0)